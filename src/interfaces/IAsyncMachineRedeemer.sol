...
interface IAsyncMachineRedeemer is IMachinePeriphery {
    ...
    /// @notice Creates a redeem request and issues an associated NFT to the recipient.
    /// @param shares The amount of shares to redeem.
    /// @param recipient The recipient of the receipt NFT.
    /// @return requestId The ID of the redeem request.
    function requestRedeem(uint256 shares, address recipient) external returns (uint256);
