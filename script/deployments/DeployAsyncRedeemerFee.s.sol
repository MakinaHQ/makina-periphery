...
contract DeployAsyncRedeemerFee is Base, Script, SortedParams {
    ...
    constructor() {
        ...
        // load input params
        inputPath = string.concat(basePath, "inputs/redeemers/async-redeemer-fees/");
        ...
        outputPath = string.concat(basePath, "outputs/redeemers/async-redeemer-fees/");
    ...
    function run() public {
        ...
        deployedInstance = IHubPeripheryFactory(_hubPeriphery.hubPeripheryFactory).createRedeemer(
            implemId, abi.encode(finalizationDelay, minRedeemAmount, whitelistStatus, redeemFeeRate)
        );
